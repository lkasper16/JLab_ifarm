...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::valarray<int>*)
   {
      ::valarray<int> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::valarray<int>),0);
      static ::ROOT::TGenericClassInfo 
         instance("valarray<int>", "prec_stl/valarray", 29,
                  typeid(::valarray<int>), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::valarray<int>*)
   {
   ...
   static void valarraylEintgR_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const ::valarray<int>*)0x0)->GetClass();
   }
...
} // end of namespace ROOTDict for class ::valarray<int>
...
namespace ROOTDict {
   ...
   // Function generating the singleton type initializer
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::valarray<long>*)
   {
      ::valarray<long> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::valarray<long>),0);
      static ::ROOT::TGenericClassInfo 
         instance("valarray<long>", "prec_stl/valarray", 29,
                  typeid(::valarray<long>), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::valarray<long>*)
   {
   ...
   // Dictionary for non-ClassDef classes
   static void valarraylElonggR_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const ::valarray<long>*)0x0)->GetClass();
   }
...
} // end of namespace ROOTDict for class ::valarray<long>
...
namespace ROOTDict {
   ...
   // Function generating the singleton type initializer
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::valarray<double>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("valarray<double>", "prec_stl/valarray", 29,
                  typeid(::valarray<double>), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::valarray<double>*)
   {
   ...
   // Dictionary for non-ClassDef classes
   static void valarraylEdoublegR_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const ::valarray<double>*)0x0)->GetClass();
   }
...
} // end of namespace ROOTDict for class ::valarray<double>
