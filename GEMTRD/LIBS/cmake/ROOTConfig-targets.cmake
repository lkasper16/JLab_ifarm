...
foreach(_expectedTarget Cint Reflex genmap Cintex Rint Thread New rootcint rlibmap Core rmkdepend MathCore Matrix Minuit Fumili Physics MLP Quadp Foam Smatrix SPlot GenVector Genetic Hist HistPainter Spectrum SpectrumPainter Hbook Tree TreePlayer TreeViewer RIO SQLIO XMLIO XMLParser Net RootAuth Krb5Auth RLDAP Gpad Graf Postscript mathtext GX11 GX11TTF ASImage ASImageGui GQt Graf3d X3d Eve RGL GLEW FTGL Gviz3d Gui Ged FitPanel GuiBld GuiHtml Recorder SessionViewer QtRoot Proof ProofPlayer ProofDraw ProofBench Html EG VMC Geom GeomBuilder GeomPainter root minicern MemStat rootn.exe roots.exe ssh2rpd root.exe proofserv.exe hadd g2root h2root RMySQL RPgSQL RSQLite TMVA)
...
# Create imported target RLDAP
add_library(RLDAP SHARED IMPORTED)
...
# Create imported target RPgSQL
add_library(RPgSQL SHARED IMPORTED)

# Create imported target RSQLite
add_library(RSQLite SHARED IMPORTED)
