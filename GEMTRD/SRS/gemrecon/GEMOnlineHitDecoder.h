...
public:
  ...
  GEMOnlineHitDecoder(Int_t iEntry, Int_t nbOfTS, Int_t startTS, Int_t stopTS, Int_t zeroSupCut, Int_t comModeCut, TString isPeakOrSum,  TString centralOrAllStrips, Float_t minADCs, Int_t minClustSize, Int_t maxClustSize, Int_t maxClustMult);
  ~GEMOnlineHitDecoder();
...
public:
  ...
  void FillClusterHistos(TString plane, TH1F* posHist, TH1F* adcHist, TH1F* adcDistHist, TH1F* clusterSizeHist, TH1F* clusterMultHist) ;
  void Fill2DClusterHistos(TString det, TH2F* pos2DHist,  TH2F* adc2DHist, TH2F* tSampleHist, TH2F* chShareingHist, TH1F* chRatioHist) ;
  void FillPos2D(TH2F* posHist, TH2F* adcHist, TH2F* tSampleHist, Float_t xpos, Float_t ypos, Float_t adc, Float_t timing) ;
